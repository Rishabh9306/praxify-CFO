    ...
    <div className="container mx-auto p-8 max-w-4xl">
      ...
      <div className="mt-8 bg-red-900 p-4 rounded-lg">
        ...
        <ol className="list-decimal list-inside space-y-2">
          ...
          <li>Check backend logs: <code className="bg-black px-2 py-1 rounded">docker logs praxifi-cfo-aiml-engine</code></li>
          <li>Check CORS_ORIGINS: <code className="bg-black px-2 py-1 rounded">docker exec praxifi-cfo-aiml-engine printenv CORS_ORIGINS</code></li>
