  ...
  constructor() {
    super({
      ...
      void main() {
        ...
        // Cyan -> powder blue radial gradient (normalized by plane scale)
      ...
      uniforms: {
        ...
        // Default gradient colors and plane scale
        // cyan
        uColorA: { value: new THREE.Color(0x00ffff) },
        // powder blue (#B0E0E6)
        uColorB: { value: new THREE.Color(0xb0e0e6) },
