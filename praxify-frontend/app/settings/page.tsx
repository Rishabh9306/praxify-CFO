...
export default function SettingsPage() {
  ...
  useEffect(() => {
    ...
    const storedApiKey = localStorage.getItem('praxify-api-key') || '';
    const storedPersona = localStorage.getItem('praxify-default-persona') as PersonaMode || 'finance_guardian';
    const storedUserName = localStorage.getItem('praxify-user-name') || '';
  ...
  const handleSaveSettings = () => {
    ...
    localStorage.setItem('praxify-api-key', apiKey);
    localStorage.setItem('praxify-default-persona', defaultPersona);
    localStorage.setItem('praxify-user-name', userName);
  ...
  const handleClearData = () => {
    if (confirm('Are you sure you want to clear all local data? This will remove all session history.')) {
      localStorage.removeItem('praxify-cfo-sessions');
      ...
      <div className="container max-w-4xl mx-auto px-4">
        <div className="mb-12">
          ...
          <p className="text-muted-foreground text-lg">
            Configure your Praxify CFO experience
          </p>
        </div>
