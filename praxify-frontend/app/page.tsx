      ...
      <footer className="py-16 bg-black/50 border-t border-border/30">
        <div className="container mx-auto px-8 md:px-12 lg:px-16">
          <div className="grid md:grid-cols-4 gap-12 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm text-muted-foreground">
                ...
                <li><a href="https://github.com/Rishabh9306/praxify-CFO" target="_blank" rel="noopener noreferrer" className="hover:text-foreground transition-colors">GitHub</a></li>
              </ul>
            </div>
            <div>
            ...
            <div>
              <h3 className="font-bold text-lg mb-6 font-mono text-white">PRAXIFY CFO</h3>
          ...
          <div className="text-center text-sm text-muted-foreground border-t border-border/50 pt-8">
            <p className="font-mono">© {new Date().getFullYear()} Praxify CFO. All rights reserved. Built with ❤️ using AI/ML</p>
          </div>
        </div>
      </footer>
      </div>
